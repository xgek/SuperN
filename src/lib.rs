...
#[derive(Debug)]
pub struct NFTMarketProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NFTMarketProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NFTMarket processing");
    
    let mut processor = NFTMarketProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NFTMarketProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NFTMarketProcessor::new(false);
